...
class LaunchFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater,
        ...
        binding.launchFindMyRepresentativesButton.setOnClickListener { navToRepresentatives() }
        binding.launchUpcomingElectionButton.setOnClickListener { navToElections() }
